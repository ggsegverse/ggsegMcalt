# Quick instructions for AI coding agents working on ggsegMcalt
...
- `R/sysdata.rda` — Internal `ggseg_atlas` objects (2D + 3D in one object)
- `R/data.R` — Roxygen2 documentation for each atlas
- `R/ggsegMcalt-package.R` — Package-level docs, imports ggseg.formats
...
- URLs point to `ggsegverse` GitHub org
